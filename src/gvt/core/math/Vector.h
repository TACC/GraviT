 ...
 namespace gvt {
    namespace core {
        namespace math {
            ...
            {
                return gvt::core::math::Vector4<T>(min(a[0], b[0]), min(a[1], b[1]), min(a[2], b[2]),
                    min(a[3], b[3]));
            }
            ...
            {
                return gvt::core::math::Vector4<T>(max(a[0], b[0]), max(a[1], b[1]), max(a[2], b[2]),
                    max(a[3], b[3]));
            }
            ...
            template <class T>
            Vector3<T> vector4to3(Vector4<T> &v) 
            {
