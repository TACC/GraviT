            ...
            namespace manta {
                namespace data {
                    ...
                    struct transform_impl<gvt::render::actor::Ray, Manta::Ray> 
                    {
                        ...
                        {
                            Manta::Ray ray;
                            const Manta::Vector orig = gvt::render::adapter::manta::data::transform<gvt::core::math::Point4f, Manta::Vector>(r.origin);
                            const Manta::Vector dir = gvt::render::adapter::manta::data::transform<gvt::core::math::Vector4f, Manta::Vector>(r.direction);
                            ray.set(orig, dir);
                            return ray;
                        }
                    };
            ...
            //        };
                    ...
                    struct transform_impl<Manta::Mesh*, gvt::render::data::primitives::Mesh*> 
                    {
                        ...
                        static inline gvt::render::data::primitives::Mesh* transform(Manta::Mesh* mesh) 
                        {
                            ...
                            {
                                gvt::core::math::Point4f vertex = gvt::render::adapter::manta::data::transform<Manta::Vector, gvt::core::math::Point4f>(mesh->vertices[i]);
