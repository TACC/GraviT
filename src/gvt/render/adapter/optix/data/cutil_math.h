...
inline  __device__ float2 prod(float2 a, float2 b)
{
    return make_float2(a.x * b.x, a.y * b.y);
}
inline  __device__ void operator*=(float2 &a, float2 b)
...
inline  __device__ int2 prod(int2 a, int2 b)
{
    return make_int2(a.x * b.x, a.y * b.y);
}
inline  __device__ void operator*=(int2 &a, int2 b)
...
inline  __device__ uint2 prod(uint2 a, uint2 b)
{
    return make_uint2(a.x * b.x, a.y * b.y);
}
inline  __device__ void operator*=(uint2 &a, uint2 b)
...
inline  __device__ float3 prod(float3 a, float3 b)
{
    return make_float3(a.x * b.x, a.y * b.y, a.z * b.z);
}
inline  __device__ void operator*=(float3 &a, float3 b)
...
inline  __device__ int3 prod(int3 a, int3 b)
{
    return make_int3(a.x * b.x, a.y * b.y, a.z * b.z);
}
inline  __device__ void operator*=(int3 &a, int3 b)
...
inline  __device__ uint3 prod(uint3 a, uint3 b)
{
    return make_uint3(a.x * b.x, a.y * b.y, a.z * b.z);
}
inline  __device__ void operator*=(uint3 &a, uint3 b)
...
inline  __device__ float4 prod(float4 a, float4 b)
{
    return make_float4(a.x * b.x, a.y * b.y, a.z * b.z,  a.w * b.w);
}
inline  __device__ void operator*=(float4 &a, float4 b)
...
inline  __device__ int4 prod(int4 a, int4 b)
{
    return make_int4(a.x * b.x, a.y * b.y, a.z * b.z,  a.w * b.w);
}
inline  __device__ void operator*=(int4 &a, int4 b)
...
inline  __device__ uint4 prod(uint4 a, uint4 b)
{
    return make_uint4(a.x * b.x, a.y * b.y, a.z * b.z,  a.w * b.w);
}
inline  __device__ void operator*=(uint4 &a, uint4 b)
...
inline  __device__ float operator*(float2 a, float2 b)
{
...
inline  __device__ float operator*(float4 a, float4 b)
{
    return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
}

inline  __device__ int operator*(int2 a, int2 b)
{
    return a.x * b.x + a.y * b.y;
}
inline  __device__ int operator*(int3 a, int3 b)
{
    return a.x * b.x + a.y * b.y + a.z * b.z;
}
inline  __device__ int operator*(int4 a, int4 b)
{
    return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
}

inline  __device__ uint operator*(uint2 a, uint2 b)
{
    return a.x * b.x + a.y * b.y;
}
inline  __device__ uint operator*(uint3 a, uint3 b)
{
    return a.x * b.x + a.y * b.y + a.z * b.z;
}
inline  __device__ uint operator*(uint4 a, uint4 b)
{
    return a.x * b.x + a.y * b.y + a.z * b.z + a.w * b.w;
}
