 ...
 */
#ifndef GVT_VECTOR_HEADER
#define GVT_VECTOR_HEADER
...
namespace GVT {
    namespace Math {
        ...
        template <class T>
        Vector<T>::Vector(int size, bool zeroElements) {
            numElements = size;
            n = new T[size];
        ...
        template <class T>
        void Vector<T>::resize(int size, bool zeroElements) {
            if (numElements != size) {
                numElements = size;
                delete [] n;
        ...
        template <class T>
        GVT::Math::Vector<T> minimum(const GVT::Math::Vector<T>& a, const GVT::Math::Vector<T>& b) {
#ifdef _DEBUG
        ...
        template <class T>
        GVT::Math::Vector<T> maximum(const GVT::Math::Vector<T>& a, const GVT::Math::Vector<T>& b) {
#ifdef _DEBUG
            if (a.numElements != b.numElements)
                throw VectortorSizeMismatch();
#endif
        ...
        template <class T>
        GVT::Math::Vector<T> prod(const GVT::Math::Vector<T>& a, const GVT::Math::Vector<T>& b) {
#ifdef _DEBUG
            if (a.numElements != b.numElements)
                throw VectortorSizeMismatch();
#endif
        ...
        template <class T>
        inline GVT::Math::Vector3<T> minimum(const GVT::Math::Vector3<T>& a, const GVT::Math::Vector3<T>& b) {
            return GVT::Math::Vector3<T>(min(a[0], b[0]), min(a[1], b[1]), min(a[2], b[2]));
        }

        template <class T>
        inline GVT::Math::Vector3<T> maximum(const GVT::Math::Vector3<T>& a, const GVT::Math::Vector3<T>& b) {
            return GVT::Math::Vector3<T>(max(a[0], b[0]), max(a[1], b[1]), max(a[2], b[2]));
        }

        template <class T>
        inline GVT::Math::Vector3<T> prod(const GVT::Math::Vector3<T>& a, const GVT::Math::Vector3<T>& b) {
            return GVT::Math::Vector3<T>(a[0] * b[0], a[1] * b[1], a[2] * b[2]);
        }

        template <class T>
        inline GVT::Math::Vector4<T> minimum(const GVT::Math::Vector4<T>& a, const GVT::Math::Vector4<T>& b) {
            return GVT::Math::Vector4<T>(min(a[0], b[0]), min(a[1], b[1]), min(a[2], b[2]),
                    min(a[3], b[3]));
        }

        template <class T>
        inline GVT::Math::Vector4<T> maximum(const GVT::Math::Vector4<T>& a, const GVT::Math::Vector4<T>& b) {
            return GVT::Math::Vector4<T>(max(a[0], b[0]), max(a[1], b[1]), max(a[2], b[2]),
                    max(a[3], b[3]));
        }

        template <class T>
        inline GVT::Math::Vector4<T> prod(const GVT::Math::Vector4<T>& a, const GVT::Math::Vector4<T>& b) {
            return GVT::Math::Vector4<T>(a[0] * b[0], a[1] * b[1], a[2] * b[2], a[3] * b[3]);
        }

        template <class T>
        GVT::Math::Vector3<T> vector4to3(GVT::Math::Vector4<T> &v) {
