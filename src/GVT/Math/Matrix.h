...
#ifndef GVT_MATRIX_HEADER
#define GVT_MATRIX_HEADER
...
namespace GVT {
    namespace Math {
        ...
        public:
            ...
            AffineTransformMatrix(T n0, T n1, T n2, T n3, T n4, T n5, T n6, T n7, T n8, T n9, T n10, T n11, T n12, T n13, T n14, T n15) {
                n[ 0] = n0;
                n[ 1] = n1;
                n[ 2] = n2;
                n[ 3] = n3;
            ...
            AffineTransformMatrix<T> transpose() const {
                return AffineTransformMatrix<T>(n[ 0], n[ 4], n[ 8], n[12],
                        n[ 1], n[ 5], n[ 9], n[13],
                        n[ 2], n[ 6], n[10], n[14],
                        n[ 3], n[ 7], n[11], n[15]);
            }
            ...
            template <class U> friend AffineTransformMatrix<T> operator +(const AffineTransformMatrix<T>& a, const AffineTransformMatrix<T>& b);
            template <class U> friend AffineTransformMatrix<T> operator -(const AffineTransformMatrix<T>& a, const AffineTransformMatrix<T>& b);
            template <class U> friend AffineTransformMatrix<T> operator *(const AffineTransformMatrix<T>& a, const AffineTransformMatrix<T>& b);
        ...
        template <class T>
        inline Matrix3<T> Matrix3<T>::createTranslation(T x, T y) {
            Matrix3<T> trans;
            std::cout << "unimplemented matrix command!" << std::endl;
            return trans;
        }
        ...
        template <class T>
        inline Matrix3<T> Matrix3<T>::createScale(T sx, T sy) {
            Matrix3<T> scale;
            std::cout << "unimplemented matrix command!" << std::endl;
            return scale;
        }
        ...
        template <class T>
        inline Matrix3<T> Matrix3<T>::createShear(T shx, T shy) {
            Matrix3<T> shear;
            std::cout << "unimplemented matrix command!" << std::endl;
            return shear;
        }
        ...
        template <class T>
        inline Matrix3<T> operator -(const Matrix3<T>& a) {
            return Matrix3<T>(-a.n[0], -a.n[1], -a.n[2],
                    -a.n[3], -a.n[4], -a.n[5],
                    -a.n[6], -a.n[7], -a.n[8]);
        }
        ...
        inline Matrix3<T> operator *(const Matrix3<T>& a, const double d) {
            return Matrix3<T>(a.n[0] * d, a.n[1] * d, a.n[2] * d,
        ...
        template <class T>
        inline AffineTransformMatrix<T> AffineTransformMatrix<T>::createTranslation(T x, T y, T z) {
        ...
        template <class T>
        inline AffineTransformMatrix<T> AffineTransformMatrix<T>::createScale(T sx, T sy, T sz) {
        ...
        template <class T>
        inline AffineTransformMatrix<T> AffineTransformMatrix<T>::createShear(T shx, T shy, T shz) {
        ...
        template <class T>
        inline Vector3<T> clamp(const Vector3<T>& other) {
        ...
        template <class T>
        inline void makeDiagonal(AffineTransformMatrix<T>& m, T k) {
            m[0][0] = k;
            m[0][1] = 0.0;
            m[0][2] = 0.0;
            m[0][3] = 0.0;
