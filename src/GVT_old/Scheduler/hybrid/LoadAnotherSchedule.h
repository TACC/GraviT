...
#ifndef GVT_LOADANOTHERSCHEDULE_H
#define	GVT_LOADANOTHERSCHEDULE_H

#include "HybridBaseSchedule.h"

struct LoadAnotherSchedule : public HybridBaseSchedule {

    LoadAnotherSchedule(int * newMap, int &size, int *map_size_buf, int **map_recv_bufs, int *data_send_buf) : HybridBaseSchedule(newMap, size, map_size_buf, map_recv_bufs, data_send_buf) {
    ...
    virtual void operator()() {
        DEBUG(cerr << "in LoadAnother schedule" << endl);
...
#endif	/* GVT_LOADANOTHERSCHEDULE_H */
