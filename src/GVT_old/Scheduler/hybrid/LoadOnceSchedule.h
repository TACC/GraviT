...
#ifndef GVT_LOADONCESCHEDULE_H
#define	GVT_LOADONCESCHEDULE_H

#include "HybridBaseSchedule.h"

struct LoadOnceSchedule : public HybridBaseSchedule {

    LoadOnceSchedule(int * newMap, int &size, int *map_size_buf, int **map_recv_bufs, int *data_send_buf) : HybridBaseSchedule(newMap, size, map_size_buf, map_recv_bufs, data_send_buf) {
    ...
    virtual void operator()() {
        DEBUG(cerr << "in LoadOnce schedule" << endl);
