...
//    
//}
//Cell::Cell(int id, float* ) {
//}

namespace GVT {
    namespace Domain {

        gvtCell::gvtCell(const gvtCell& other) {
        ...
        bool gvtCell::MakeCell(int id, gvtCell& cell, vector<int>& dim, vector<float> min, vector<float> max, vector<float>& cell_dim, float* data) {
        ...
        bool gvtCell::FindFaceIntersectionsWithRay(GVT::Data::ray& r, vector<gvtCell::Face>& faces) {
        ...
        ostream&
        operator<<(ostream& os, gvtCell::Face const& f) {
