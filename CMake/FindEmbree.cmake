...
IF(EXISTS "${EMBREE_BUILD_PREFIX}/lib")
  SET(EMBREE_LINK_DIRECTORIES ${EMBREE_BUILD_PREFIX}/lib ${EMBREE_LINK_DIRECTORIES})
ENDIF()

IF(EXISTS "${EMBREE_BUILD_PREFIX}/lib64")
  SET(EMBREE_LINK_DIRECTORIES ${EMBREE_BUILD_PREFIX}/lib64 ${EMBREE_LINK_DIRECTORIES})
ENDIF()
