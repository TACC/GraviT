...
IF(NOT GVT_DIR)
  SET(GVT_DIR ${CMAKE_CURRENT_SOURCE_DIR})
ENDIF(NOT GVT_DIR)
#MACRO(CONFIGURE_GVT)
...
ELSEIF ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
  SET(GVT_COMPILER ${CMAKE_CXX_COMPILER_ID} CACHE STRING "GraviT Compiler?")
  INCLUDE(${GVT_DIR}/CMake/gcc.cmake)
ELSEIF ("${CMAKE_CXX_COMPILER_ID}" STREQUAL "Intel")
  SET(GVT_COMPILER ${CMAKE_CXX_COMPILER_ID} CACHE STRING "GraviT Compiler?")
  INCLUDE(${GVT_DIR}/CMake/icc.cmake)
...
ELSEIF (${GVT_VECTOR_TARGET} STREQUAL "AVX512KNL")
 ADD_DEFINITIONS(-DGVT_SIMD_WIDTH=16)
 ADD_DEFINITIONS(-DGVT_TARGET_AVX512=1)
 SET(GVT_ISPC_TARGET "avx512knl-i32x16")
ELSEIF (${GVT_VECTOR_TARGET} STREQUAL "AVX512SKX")
 ADD_DEFINITIONS(-DGVT_SIMD_WIDTH=16)
 ADD_DEFINITIONS(-DGVT_TARGET_AVX512=1)
 SET(GVT_ISPC_TARGET "avx512skx-i32x16")
