...
export QTLIB=/opt/apps/qt5/5.11.2/lib

export LD_LIBRARY_PATH=$LIBSTDC:$LD_LIBRARY_PATH:$embree_DIR/lib64:$MPI_DIR/lib64:$IceT_LIB_DIR:$gvt_DIR/lib:$ospray_DIR/lib64:$Galaxy_LIB_DIR:$VTK_LIB_DIR:$TBB_LIB:$qhull_LIB_DIR:$QTLIB
